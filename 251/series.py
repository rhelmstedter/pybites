...
def basic_series() -> pd.Series:
    ...
    """
    return pd.Series(data=[num for num in range(1, 6)], name="Fred")
...
def float_series() -> pd.Series:
    ...
    """
    return pd.Series(data=[num / 1000 for num in range(0, 1001)])
...
def alpha_index_series() -> pd.Series:
    ...
    """
    return pd.Series(
        data=[num for num in range(1, 27)], index=[c for c in string.ascii_lowercase]
    )
...
def object_values_series() -> pd.Series:
    ...
    """
    return pd.Series(
        data=[c for c in string.ascii_uppercase], index=[num for num in range(101, 127)]
    )
