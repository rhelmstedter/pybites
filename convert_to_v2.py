...
def slugify(text):
    ...
    return text.strip().lower().replace(" ", "_").replace("__", "_")
...
def create_bite_map(bites):
    ...
    for line in bites.splitlines():
        ...
        bites_map[bite_num] = slugify(description)
    return bites_map
